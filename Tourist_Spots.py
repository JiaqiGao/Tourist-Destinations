...
styling1='''
body {
background-image:url('http://www.bonkoo.com/static/imgs/cover/nyc.jpg');
background-size: 100%;
...
<h1><center>List of Tourist Spots</center></h1>
...
<div class="navbar navbar-inverse navbar-fixed-bottom">
  <div class="navbar-header">
    <a class="navbar-brand" href="Tourist_Spots">Back
    </a>
  </div>
</div>
</div>
        ...
        if i[0] == which_region:
            if i[1].replace(' ', '') == which_county:
                if which_tag in i[6]:
                    ...
                    _id=name+"_id"
                    i.append('''
    var '''+name+" = new google.maps.LatLng"+i[10]+''';
    var '''+Opt+''' = {
   zoom: 15,
   center: '''+name+'''
    }
   ...
   var '''+_mark+''' = new google.maps.Marker({
    ...
    if len(regions)<1:
        ...
        for k in regions:
            ...
            if k[8]!='':
                result+='<tr><th><a href="'+k[8]+'">'+k[2]+'</a></th>'
